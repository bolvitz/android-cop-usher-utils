package com.eventmonitor.core.domain.validation
...
object Validators {
    ...
    ): com.eventmonitor.core.domain.common.Result<T> {
        val errors = collectErrors(*validators)
        return if (errors.isEmpty()) {
            com.eventmonitor.core.domain.common.Result.Success(value)
        } else {
            com.eventmonitor.core.domain.common.Result.Error(
                com.eventmonitor.core.domain.common.AppError.ValidationError(errors)
            )
        }
    }
}
