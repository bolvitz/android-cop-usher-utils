...
val MIGRATION_3_4 = object : Migration(3, 4) {
    override fun migrate(db: SupportSQLiteDatabase) {
        ...
        db.execSQL("CREATE INDEX IF NOT EXISTS idx_services_branch_type ON services(branchId, serviceTypeId)")

        // Area counts table - optimize service + template queries
        db.execSQL("CREATE INDEX IF NOT EXISTS idx_area_counts_service_template ON area_counts(serviceId, areaTemplateId)")
